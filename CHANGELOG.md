...
- [#440](https://github.com/GabeDuarteM/blocky-ui/pull/440) [`43f2de9`](https://github.com/GabeDuarteM/blocky-ui/commit/43f2de9ea0c4449e38a32e3acfd700232042a5cf) Thanks [@GabeDuarteM](https://github.com/GabeDuarteM)! - Support reading query log targets from secret files in YAML configuration. Use a `file:` or `file://` prefix instead of writing the target inline:
...
- [#456](https://github.com/GabeDuarteM/blocky-ui/pull/456) [`7e652bc`](https://github.com/GabeDuarteM/blocky-ui/commit/7e652bc71d3a6103bdb424d1801af40388e5e723) Thanks [@GabeDuarteM](https://github.com/GabeDuarteM)! - Show a 24-hour traffic chart for setups without query logs, using hourly total and blocked queries from Blocky's statistics API.

  Enable [statistics](https://0xerr0r.github.io/blocky/latest/configuration/#statistics) in Blocky to use it. The history resets when Blocky restarts. Query logs still provide longer history and filtering.

### Patch Changes

- [#455](https://github.com/GabeDuarteM/blocky-ui/pull/455) [`a2a565f`](https://github.com/GabeDuarteM/blocky-ui/commit/a2a565fe2e044129c740d385e1cc0e424dc9ce04) Thanks [@GabeDuarteM](https://github.com/GabeDuarteM)! - Recognize `REBIND` responses in query logs, with a response filter, a red badge, and a tooltip explaining DNS rebinding protection.
